...
Visualization is key to exploring and understanding Earth data. Web browsers offer a near-universal platform for data exploration. However, web users expect near instantaneous page rendering. The scale of geospatial data makes it challenging to serve this data instantaneously as browsers cannot read, reproject and create image tiles fast enough for a good user experience.
